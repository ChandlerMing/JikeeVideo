...
INSERT INTO `tbl_video_desc` (`vid`, `coverUrl`, `videoDesc`) VALUES
(1, '/img/1.jpg', '暂无视频简介?不，这是一个测试视频，当然需要有简介。'),
(2, './img/2.jpg', '暂无视频简介?不，这是一个测试视频，当然需要有简介。'),
(3, './img/3.jpg', '暂无视频简介?不，这是一个测试视频，当然需要有简介。'),
(4, './img/4.jpg', '暂无视频简介?不，这是一个测试视频，当然需要有简介。'),
(5, './img/5.jpg', '暂无视频简介?不，这是一个测试视频，当然需要有简介。'),
(6, './img/6.jpg', '暂无视频简介?不，这是一个测试视频，当然需要有简介。'),
(7, './img/7.jpg', '暂无视频简介?不，这是一个测试视频，当然需要有简介。'),
(8, '/img/20200708164008395.jpg', '！！！！！！！！！！！！！！！！！！！！！！！！');
...
CREATE TABLE `tbl_video_hot` (
  `hotid` int(11) NOT NULL COMMENT '热度排名',
  `vid` int(11) NOT NULL COMMENT '视频编号'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `tbl_video_hot`
--

INSERT INTO `tbl_video_hot` (`hotid`, `vid`) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
...
--
-- 使用表AUTO_INCREMENT `tbl_video_hot`
--
ALTER TABLE `tbl_video_hot`
  MODIFY `hotid` int(11) NOT NULL AUTO_INCREMENT COMMENT '热度排名', AUTO_INCREMENT=8;
COMMIT;
