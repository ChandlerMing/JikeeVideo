...
<nav id="topNavBar" class="navbar navbar-expand-md navbar-light bg-light border-bottom">
    ...
    <!--Logo文字-->
    <a href="index.php" class="text-decoration-none h2 LogoText">极刻视频</a>
    ...
    <div id="navbar" class="collapse navbar-collapse justify-content-end">
        ...
        <ui class="navbar-nav mr-3 <?php echo $login?'':'d-none'?>">
            ...
            <li><a class="nav-link" href="index.php?action=logout" onclick="return confirm('您确定要退出登录吗？');">退出登录</a></li>
        </ui>
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="d-flex">
                                ...
                                <a class="ml-1 text-decoration-none small align-self-end" href="#" id="change">看不清，换一张</a></td></tr>
                            </div>
                            <input name="verifyCode" class="form-control w-25 ml-auto" type="password" placeholder="">
                        </div>
                    </div>
                    <div class="form-group d-flex align-items-center">
                        <input name="autoLogin" type="checkbox" placeholder="">
                        <small class="pl-1 pb-lg-1">下次自动登录</small>
                    </div>
                    <div class="text-right">
